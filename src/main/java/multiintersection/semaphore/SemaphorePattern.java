...
public class SemaphorePattern {
	...
	public static final String RED_SYMBOL = "0";
	 ...
	 * allo stesso flow Non è il massimo ma con il fatto che utilizziamo una stringa
	 ...
	 * potrebbe essere formata anche da più di un carattere Si potrebbe risolvere
